 ...
 * which breaks here: the creator lives at /creator and the published view at
 * /view, so they would read and write different key prefixes, and the GitHub
 * Pages base would shift them again. Callers pass an explicit projectId
 * instead — see `src/doc/remote.ts` for this app's wiring.
 */
